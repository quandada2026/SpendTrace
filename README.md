...
- **当前版号：1.0.0**——数据安全闭环达成（P1 复核草稿持久化：进程被杀不丢单），正式发布线。
- 历史：`v1.0` tag 为早期内部里程碑（OCR 容错重构、多图上传、日历补记/翻月热力、上传日期归属、统计按月联动、分类关键词扩充、日期识别增强、复核页日期选择器、杂志靛蓝瓷主题、全年汇总双列等已全部并入 1.0.0）。
